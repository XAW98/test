    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'key' => 'app_name', // unique name for field
                'label' => 'App Name', // you know what label it is
                'rules' => 'required|min:2|max:50', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'X-CMS', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'key' => 'footer_text', // unique name for field
            ...
            [
                ...
                'key' => 'show_copyright', // unique name for field
    ...
    'email' => [
        ...
        'elements' => [
            [
                ...
                'data' => 'string', // data type, string, int, boolean
                'key' => 'email', // unique name for field
    ...
    'social' => [
        ...
        'elements' => [
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'key' => 'facebook_url', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'key' => 'twitter_url', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'key' => 'instagram_url', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'key' => 'linkedin_url', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'key' => 'youtube_url', // unique name for field
    ...
    'meta' => [
        ...
        'elements' => [
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_site_name', // unique name for field
                'label' => 'Meta Site Name', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Awesome Laravel | A X-CMS Project', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_description', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_keyword', // unique name for field
                'label' => 'Meta Keyword', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, Laravel,X-CMS,Bootstrap,Admin,Template,Open,Source, nasir khan, nasirkhan', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_image', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_fb_app_id', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_twitter_site', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'meta_twitter_creator', // unique name for field
    ...
    'analytics' => [
        ...
        'elements' => [
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'key' => 'google_analytics', // unique name for field
    ...
    'custom_css' => [
        ...
        'elements' => [
            [
                ...
                'data' => 'string', // data type, string, int, boolean
                'key' => 'custom_css_block', // unique name for field
